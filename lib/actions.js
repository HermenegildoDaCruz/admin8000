...
//   db.prepare(`INSERT INTO Department (name) VALUES (?)`).run("Recursos Humanos");
//   db.prepare(`INSERT INTO Department (name) VALUES (?)`).run("Financeiro");
//   db.prepare(`INSERT INTO Department (name) VALUES (?)`).run("Tecnologia");
// }

// export async function addUsers(){
//   db.prepare(`INSERT INTO User (password, access_level , id_department) VALUES (?, ?, ?)`).run("admin123", 0, 1);
// }
